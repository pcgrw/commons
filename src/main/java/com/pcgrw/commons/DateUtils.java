...
public class DateUtils {
     ...
     * @throws ParseException
     */
    public static String getLastMonthFirstDay(String currentDate, String pattern) throws ParseException {
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat(pattern);
        Date date = simpleDateFormat.parse(currentDate);
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
     ...
     * @throws ParseException
     */
    public static String getLastMonthFirstDay(String currentDate) throws ParseException {
        return getLastMonthFirstDay(currentDate, DEFAULT_PATTERN);
    }
     ...
     * @throws ParseException
     */
    public static String getLastMonthEndDay(String currentDate, String pattern) throws ParseException {
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat(pattern);
        Date date = simpleDateFormat.parse(currentDate);
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
     ...
     * @throws ParseException
     */
    public static String getLastMonthEndDay(String currentDate) throws ParseException {
        return getLastMonthEndDay(currentDate, DEFAULT_PATTERN);
    }
     ...
     * @throws ParseException
     */
    public static String getNextMonthEndDay(String currentDate, String pattern) throws ParseException {
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat(pattern);
        Date date = simpleDateFormat.parse(currentDate);
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
     ...
     * @throws ParseException
     */
    public static String getNextMonthEndDay(String currentDate) throws ParseException {
        return getNextMonthEndDay(currentDate, DEFAULT_PATTERN);
    }
}
